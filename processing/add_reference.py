...
# list
cleaned = {"data": []}
for cantique in data:
    full = 0
    cantique["references"] = {"fr": cantique["number"], "en": 0, "ful": 0}
    if (int(cantique["number"])) in ful2fr:
        full = ful2fr[int(cantique["number"])]
        cantique["references"] = {"fr": cantique["number"], "en": 0, "ful": full}

    cleaned["data"].append(cantique)
    # write content of clean in json file out
    with open("../assets/data/hymns_with_ref.json", "w", encoding="utf-8") as f:
