...
@immutable
class SabbathSongsTheme extends ThemeExtension<SabbathSongsTheme> {
  const SabbathSongsTheme({
    this.primaryColor = const Color(0xFF005481),
    this.tertiaryColor = const Color(0xFF00FF00),
  ...
  ThemeData _base(final ColorScheme colorScheme) {
    final primaryTextTheme = GoogleFonts.ibmPlexSerifTextTheme();
  ...
  @override
  ThemeExtension<SabbathSongsTheme> copyWith({
    Color? primaryColor,
    Color? tertiaryColor,
    Color? neutralColor,
  }) =>
  ...
  @override
  SabbathSongsTheme lerp(
    covariant ThemeExtension<SabbathSongsTheme>? other,
    double t,
  ) {
    if (other is! SabbathSongsTheme) return this;
    return SabbathSongsTheme(
